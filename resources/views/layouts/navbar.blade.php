...
@endphp
<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 fixed w-screen top-0 lg:hidden z-100 shadow-md">
    <div class="flex justify-between items-center h-16 px-4 sm:px-6">
        ...
        <img src="{{ asset('assets/logo_app_2.png') }}" 
            alt="Logo Aplikasi" 
            class="w-[60px] mb-0 mt-0 object-contain"/>
    </div>
        ...
        <aside 
            ...
            <div>
                <img src="{{ asset('assets/logo_app_3.png') }}" 
                    alt="Logo Aplikasi" 
                    class="md:w-[50%] w-[50%] md:mt-5 md:mb-1 mb-0 mt-8 object-contain mx-auto" />
            </div>
